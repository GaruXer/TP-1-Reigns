...
public class Reigns {
    ...
    private static void reponseQuestion(Question question){
        ...
        // applique les malus
        if (reponse.equals("G")) {
            question.effetGauche.appliqueEffet(personnage);
        } else {
            question.effetDroite.appliqueEffet(personnage);
        }
    }
    ...
    private static void initBanqueQuestions(){
        ...
        Question question2 = new Question(
                ...
                new Effet("Importer de la nourriture"),
                new Effet("Ne rien faire"));
        ...
        Question question4 = new Question(
                ...
                new Effet("Le soutenir"),
                new Effet("Rester neutre"));
        ...
        Question question5 = new Question(
                ...
                new Effet("Taxer énormément"),
                new Effet("Taxer un tout petit peu"));
